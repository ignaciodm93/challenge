package com.challenge.ms.accreditations.service;
...
import com.challenge.ms.accreditations.repository.AccreditationsRepository;
...
public class AccreditationsService {
	...
	private static final Logger logger = LoggerFactory.getLogger(AccreditationsService.class);
